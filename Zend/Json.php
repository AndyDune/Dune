...
class Dune_Zend_Json
{
     ...
     * objects. See {@link Dune_Zend_Json_Decoder::decode()} for details.
     * @return mixed
     */
    public static function decode($encodedValue, $objectDecodeType = Dune_Zend_Json::TYPE_ARRAY)
    {
        if (function_exists('json_decode') && self::$useBuiltinEncoderDecoder !== true) {
            return json_decode($encodedValue, $objectDecodeType);
        }

        return Dune_Zend_Json_Decoder::decode($encodedValue, $objectDecodeType);
    }
    ...
    public static function encode($valueToEncode, $cycleCheck = false, $options = array())
    {
        ...
        return Dune_Zend_Json_Encoder::encode($valueToEncode, $cycleCheck, $options);
    }
    ...
    public static function fromXml ($xmlStringContents, $ignoreXmlAttributes=true) {   
        ...
        if ($simpleXmlElementObject == null) {      
            throw new Dune_Exception_Zend('Function fromXml was called with an invalid XML formatted string.');   
