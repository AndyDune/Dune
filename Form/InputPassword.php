 ...
 * ----------------------------------------------------
 * | Библиотека: Dune                                  |
 * | Файл: InputPassword.php                           |
 * | В библиотеке: Dune/Form/InputPassword.php         |
 ...
 * 
 */
class Dune_Form_InputPassword extends Dune_Form_Parent_InputSetClassId
{
    /**
     ...
     * @access private
     */
    protected $_string = '<input type="password">';
