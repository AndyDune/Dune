...
class Dune_Filter_Post_HtmlSpecialChars extends Dune_Filter_Parent_RequestFormatPost
{
    ...
    */
    static function getInstance($name, $def = '', $maxLength = 0)
    {
        ...
        {
            self::$instance[$key] = new Dune_Filter_Post_HtmlSpecialChars($name, $def, $maxLength);
        }
