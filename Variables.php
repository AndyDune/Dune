 ...
 * -----------------
 * 
 * 1.04 (2009 декабрь 03)
 * Внедрен статический метод инициилизации объекта-одиночки подходящим объектом извне.
 * Нашел применение при десериализации объекта.
 * Метод: setInstance($instance)
 * 
...
//////////////////////////////////////////////////////////////////
   ...
   * @return Dune_Variables
   */
    static public function setInstance($instance = null)
    {
        if ($instance instanceof Dune_Variables)
        {
