...
//////////////////////////////      Статичные методы    
   ...
   * @param string $name имя идентификатора сессии
   * @return Dune_Session
   */
     ...
     * Вызывать до вызовы метода-фабрики.
     *
     * @param string $id
     */
...
//////////////////////////////      Приватные методы    
    ...
    private function _canEditZone()
    {
        ...
        {
            throw new Dune_Exception_Base('Попытка редактирования заблокированной зоны. Зона: ' . $this->_usingZone);
        }
    }
   /**
    * @access private
