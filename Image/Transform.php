 ...
 *
 *  1.04 (2012 май 22)
 *  Ошибка вычисления масштабов тумба - расчет велся от оригинала.
 *
 *  1.03 (2009 сентябрь 11)
 *  Устранена ошибка указания режима изготовления уменьшенной копии setModeThumb() 
 * 
 *  1.02 (2009 январь 23)
...
////////////////////////////////////////////////////////
	...
	{
		//adjust
        return $this->_imageWidth / $thumbnailsize;
  		return $this->imageInfoObject->getWidth() / $thumbnailsize; // неверно, так как картинка меняется
	}
	...
	{
		//adjust
        return $this->_imageHeight / $thumbnailsize;
  		return $this->imageInfoObject->getHeight() / $thumbnailsize;  // неверно, так как картинка меняется
	}
